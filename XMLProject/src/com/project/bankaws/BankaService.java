 ...
 * 2015-06-02T16:23:26.430+02:00
 * Generated source version: 2.6.5
 * 
 */
@WebServiceClient(name = "BankaService", 
                  wsdlLocation = "file:/C:/FAX/IVgodina/xml/git/XMLProject/WEB-INF/wsdl/Banka.wsdl",
...
public class BankaService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/FAX/IVgodina/xml/git/XMLProject/WEB-INF/wsdl/Banka.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BankaService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/FAX/IVgodina/xml/git/XMLProject/WEB-INF/wsdl/Banka.wsdl");
        }
        WSDL_LOCATION = url;
    }
