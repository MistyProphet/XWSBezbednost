...
public class RESTUtil {
	...
	//	dropSchema("CB");
		/* Test CRUD operacija */
		createSchema("Banka");
		createSchema("Dokumenti");
		createResource("Banka", "TBanka", new FileInputStream(new File(file, "banke.xml")));		
		createResource("Banka", "TBankarskiRacunKlijenta", new FileInputStream(new File(file, "racuni.xml")));
		createResource("Banka", "TRacunKlijenta", new FileInputStream(new File(file, "racuni.xml")));
		createResource("Dokumenti", "MT102", new FileInputStream(new File(file, "MT102.xml")));
		createResource("Dokumenti", "MT103", new FileInputStream(new File(file, "MT103.xml")));
		createResource("Dokumenti", "NalogZaPlacanje", new FileInputStream(new File(file, "NalogZaPlacanje.xml")));
		createResource("Dokumenti", "MT900", new FileInputStream(new File(file, "MT900.xml")));
		createResource("Dokumenti", "MT910", new FileInputStream(new File(file, "MT910.xml")));
