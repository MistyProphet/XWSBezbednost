...
public class AddressBookImpl implements AddressBook {
    ...
    public yu.ac.ns.ftn.informatika.ws.address.types.ContactsType getAllContacts() { 
        ...
        try {
            yu.ac.ns.ftn.informatika.ws.address.types.ContactsType _return = null;
            return _return;
    ...
    public yu.ac.ns.ftn.informatika.ws.address.types.ContactType getContact(int index) { 
        ...
        try {
            yu.ac.ns.ftn.informatika.ws.address.types.ContactType _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
